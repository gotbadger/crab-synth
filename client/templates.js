(function (root, factory) {
    ...
    templatizer["pages"]["personView"] = function tmpl_pages_personView() {
        return '<div><h1 role="name"></h1><h3> \n(<span role="dumpPlayhead"> </span>ms)</h3><div class="btn-group"><button role="action-play" class="btn btn-default">play </button><button href="#" role="action-stop" class="btn btn-danger">stop</button></div><div class="panel"><div class="panel-body"><span role="dump"></span></div></div></div>';
    };
